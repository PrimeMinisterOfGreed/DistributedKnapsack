...
#algorithm-figure(
  ...
  supplement: none,) <alg:knapsack-rec>
...
#algorithm-figure(
  ...
  supplement: none,) <alg:knapsack-memo>
...
#algorithm-figure(
  ...
  supplement: none,) <alg:knapsack-tab>
...
#algorithm-figure(
  ...
  supplement: none,) <alg:knapsack-opt>
...
#algorithm-figure(
  ...
  supplement: none,) <alg:parallel_gen>
...
#algorithm-figure(
  ...
  supplement: none,) <alg:parallel_max>
...
#algorithm-figure(
  ...
  supplement: none,) <alg:parallel_pruning>
...
#algorithm-figure(
  ...
  supplement: none,) <alg:parallel_suffix_max>
...
#algorithm-figure(
  ...
  supplement: none,) <alg:parallel_search>
...
#figure(
  ...
  supplement: none,) <fig:kpdpshared>
...
#figure(
  ...
  supplement: none,) <fig:kpdpsharedplot>
...
#figure(
  ...
  supplement: none,) <fig:kpdpsharedefficiency>
...
#figure(
  ...
  supplement: none,) <fig:kpcopaspeedup>

#figure(
  image("images/KnapsackCOPA_speedupplot.png", width: 100%),
  caption: [Speedup dell'algoritmo KP COPA in shared memory],

  supplement: none,) <fig:kpcopaplot>
...
#figure(
  ...
  supplement: none,) <fig:kpcopavsdp>
...
#figure(
  ...
  supplement: none,) <fig:kpcopadpmpi>
