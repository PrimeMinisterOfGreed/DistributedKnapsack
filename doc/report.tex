...
\subsection{Implementazione del knapsack in dinamic programming}
...
\\
L'implementazione MPI dell'algoritmo è molto simile, l'approccio seguito è stato quello di assegnare la tabella a un master, che scompone la linea successiva da calcolare in task di una certa dimensione, i worker non dispongono dell'intera tabella ma solo della linea precedente per risparmiare memoria.
